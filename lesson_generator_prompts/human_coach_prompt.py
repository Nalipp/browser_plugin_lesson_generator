llm_coach_prompt = f"""Create a comprehensive lesson plan based on the following content:
        Title: {title}
        Content: {main_content}

        Please generate instructions for a human to conduct a practice verbal english lesson session. 

        The goal is to generate a lesson plan based on the content input that will give guidance to an instructor who wants to create a fun and engaugeing lesson that focuses on giving the student as much english speaking practice as possible.
